...
import com.apirest.bigdatanasaude.model.TokenDTO;
...
public class AuthenticationController {
    ...
    @PostMapping
    public ResponseEntity<TokenDTO> auth(@RequestBody @Validated com.irs.register.register.application.controller.auth.LoginDTO loginDTO){
